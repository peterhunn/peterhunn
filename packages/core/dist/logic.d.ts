import type { ContractData, ContractEvent, ContractResponse, ContractState, Obligation } from "./types.js";
/**
 ...
 */
export interface ContractLogic<TData extends ContractData, TEvent extends ContractEvent = ContractEvent, TResult = unknown> {
    /**
     ...
     */
    execute(event: TEvent, ctx: ContractLogicContext<TData>): ContractResponse<TResult>;
    /**
     ...
     */
    onObligationDue?(obligation: Obligation, ctx: ContractLogicContext<TData>): ContractResponse<TResult>;
}
/** Helper: build a minimal initial ContractState. */
export declare function initialState(overrides?: Partial<ContractState>): ContractState;
